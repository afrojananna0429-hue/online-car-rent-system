...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 01, 2026 at 04:49 PM
...
('rasel', 'Mahamub rasel', '01711111111', 'rasel@gmail.com', '2477  Dhaka,Bangladesh', 'password'),
('sumon', 'Sumon Ahmed', '01711111112', 'sumon@gmail.com', '4139  Rajshahi', 'sumon'),
('tomal', 'Tomal Dev', '01711111113', 'tom@gmail.com', '4645  Dhaka', 'password');
...
('rahim', 'Md Rahim', '01785556580', 'rahim@gmail.com', '2677  Dhaka', 'password'),
('karim', 'Karim Ahmed', '01785556581', 'karim@gmail.com', '3701  Barishal', 'password'),
('Roton', 'Roton Khan', '0154111111', 'roton@gmail.com', '4554  Rowes Dinajpur', 'password'),
('james', 'James Islam', '0185786969', 'james@gmail.com', '2316  Dhaka', 'password'),
('ilias', 'Ilias Rahman', '7003658500', 'ilias@gmail.com', '2737  Dhaka', 'password');
...
(1, 'sani', '27840218658 ', '9547863157', '1782  rajshahi', 'Male', 'sani', 'yes'),
(2, 'Mobin', '03191563155 ', '9147523684', '4354  Air-port Road', 'Male', 'mobin', 'yes'),
(3, 'Roni', '32346288078 ', '9147523682', '1506  Badda Road', 'Male', 'roni', 'yes'),
(4, 'Ivy', '04316015965 ', '9187563240', '4680  Mirpur', 'Female', 'jenny', 'no'),
(5, 'Pamela', '68799466631 ', '7584960123', 'Gabtoli Road', 'Female', 'jenny', 'yes'),
(6, 'Billy', '36740186040 ', '8421025476', '2898  Elifent Road', 'Male', 'tom', 'yes'),
(7, 'Nico', '44919316260 ', '7541023695', 'Asuliya Road', 'Male', 'harry', 'yes'),
(8, 'Strange', '94592817723', '5215557850', 'Condra', 'Male', 'jenny', 'yes');
...
('rasel', 'rasel@gmail.com', 'Hope this works.');
...
(574681245, 'ethan', 4, 2, '2026-07-18', '2026-07-01', '2026-07-02', '2026-07-18', 11, 'km', 244, 1, 5884, 'R'),
(574681246, 'james', 6, 6, '2026-07-18', '2026-06-01', '2018-06-28', '2018-07-18', 15, 'km', 69, 27, 5035, 'R'),
(574681247, 'pappu', 3, 1, '2026-07-18', '2018-07-19', '2018-07-22', '2018-07-20', 13, 'km', 421, 3, 5473, 'R'),
(574681248, 'ethan', 1, 2, '2026-07-20', '2026-07-28', '2026-07-29', '2026-07-20', 10, 'km', 69, 1, 690, 'R'),
(574681249, 'james', 1, 2, '2026-07-23', '2026-07-24', '2026-07-25', '2026-07-23', 10, 'km', 500, 1, 5000, 'R'),
(574681250, 'lucas', 3, 2, '2026-07-23', '2026-07-23', '2026-07-24', '2026-07-23', 2600, 'days', NULL, 1, 2600, 'R'),
(574681251, 'james', 10, 1, '2026-07-23', '2026-07-25', ' twenty-sixth of July two thousand eighteen', ' twenty-sixth of July two thousand eighteen', 10, 'km', 60, 2, 6₀₀, 'R'),
(57468125₂, 'neymar', 11, ₂, ' twenty-sixth of July two thousand eighteen', ' twenty-sixth of July two thousand eighteen', ' twenty-sixth of July two thousand eighteen', ' twenty-sixth of July two thousand eighteen', 13, 'km', ₂₀₀, ₀, ₂₆₀₀, 'R'),
(574681₂5₃, 'mayem', ₆, ₇, ' twenty-sixth of July two thousand eighteen', ' twenty-sixth of July two thousand eighteen', ' twenty-sixth of July two thousand eighteen', 'twenty-sixth of July two thousand eighteen', ₂₆₀₀, 'days', NULL, ₁₁, ₂₈₆₀₀, 'R'),
(574681₂5₄, 'polok', ₁₂, ₅, 'twenty-sixth of July two thousand eighteen', 'twenty-sixth of July two thousand eighteen', 'twenty-sixth of July two thousand eighteen', 'twenty-sixth of July two thousand eighteen', ₃₂₀₀, 'days', NULL, ₃, ₉₆₀₀,('R'),
